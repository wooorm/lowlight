 ...
 * @typedef {{type: 'root', data: {language: string|null, relevance: number}, children: Array<LowlightElementSpan|Text>}} LowlightRoot
 *
...
function highlight(language, value, options = {}) {
  ...
  // @ts-expect-error our emitter is added.
  ...
  // @ts-expect-error: `language` is always defined apparently.
